...
function LoginSignup() {
  ...
  */
  ...
  const handleRegister = async (e) => {
    ...
    try {
      const response = await axios.post("https://gestion-maintenancebackend.vercel.app/api/signup", formDataToSend, {
        headers: {
  ...
  const handleSubmitLogin = async (e) => {  
    ...
    await axios.post("https://gestion-maintenancebackend.vercel.app/api/login/", { email, password })
      .then((res) => {
